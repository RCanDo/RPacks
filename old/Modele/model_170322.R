...
##
ID$ref = "170322"			## katalog z danymi referencyjnymi na których by³ zbudowany model
ID$ref_x = "1"
...
##
## Data otwarcia:
## [1] "2017-04-01 16:48:41 CEST"
##
## Zmienne nazw tabel:
##                TABLE
## TABLE$ref =    "modele.referencja_170322"
## TABLE$ref_y =  "modele.referencja_"
## TABLE$mod =    "modele.model_170322"
##
## Zmienne nazw plików:
##                         FILE$ref
## FILE$ref$environment =  "referencja_170322_1_environment.Rdata"
## FILE$ref$Rdata =        "referencja_170322_1.Rdata"
## FILE$ref$sql =          "referencja_170322_1.sql"
## FILE$ref$xls =          "referencja_170322_1.xls"
## FILE$ref$csv =          "referencja_170322_1.csv"
##
##                         FILE$mod
## FILE$mod$environment =  "model_170322_environment.Rdata"
## FILE$mod$Rdata =        "model_170322.Rdata"
## FILE$mod$sql =          "model_170322.sql"
## FILE$mod$xls =          "model_170322.xls"
## FILE$mod$csv =          "model_170322.csv"
##
## Zmienne nazw katalogów:
##                PATH
## PATH$R =       "D:/ROBOCZY/PK_Analitycy/R"
## PATH$packs =   "D:/ROBOCZY/PK_Analitycy/R/PacksAK"
## PATH$modfun =  "D:/ROBOCZY/PK_Analitycy/Modele/Funkcje"
## PATH$ref =     "D:/ROBOCZY/PK_Analitycy/Modele/Dane Referencyjne/170322"
## PATH$mod =     "D:/ROBOCZY/PK_Analitycy/Modele/Modele/170322"
## PATH$wd =      "D:/ROBOCZY/PK_Analitycy/Modele/Modele/170322"
##
##
## Aktywnoœæ:
##                   open               write
## 1  2017-04-01 09:44:07 2017-04-01 16:46:50
## 2  2017-04-01 16:48:41 2017-04-01 16:49:44
## 3  2017-04-01 16:48:41 2017-04-01 18:42:40
## 4  2017-04-01 16:48:41 2017-04-01 18:45:19
## 5  2017-04-01 16:48:41 2017-04-01 21:54:59
## 6  2017-04-02 07:09:13 2017-04-02 08:35:27
## 7  2017-04-02 18:34:12 2017-04-02 18:47:13
## 8  2017-04-02 18:34:12 2017-04-02 23:13:00
## 9  2017-04-03 06:57:03 2017-04-03 08:18:36
## 10 2017-04-04 06:53:34 2017-04-04 07:51:44
## 11 2017-04-04 06:53:34 2017-04-04 07:56:43
## 12 2017-04-04 06:53:34 2017-04-04 08:02:34
## 13 2017-04-04 06:53:34 2017-04-04 08:07:54
## 14 2017-04-04 22:13:39 2017-04-04 22:37:12
## 15 2017-04-05 06:47:30 2017-04-05 07:56:09
## 16 2017-04-10 14:15:16 2017-04-10 14:17:13
## 17 2017-04-10 14:19:10 2017-04-10 14:19:19
## 18 2017-04-10 14:19:10 2017-04-10 16:13:45
## 19 2017-04-10 14:19:10 2017-04-10 16:27:11
## 20 2017-04-10 14:19:10 2017-04-10 17:17:17
## 21 2017-04-14 08:27:34 2017-04-14 09:28:01
## 22 2017-04-14 08:27:34 2017-04-14 13:10:55
## 23 2017-04-22 10:45:49 2017-04-22 15:55:19
## 24 2017-04-22 10:45:49 2017-04-22 20:16:43
## 25 2017-04-23 06:54:28 2017-04-23 07:35:41
## 26 2017-04-23 14:18:49 2017-04-23 15:18:27
## 27 2017-04-29 10:19:12 2017-04-29 18:48:59
## 28 2017-04-29 10:19:12 2017-04-29 19:57:16
## 29 2017-04-29 10:19:12 2017-04-29 22:57:45
## 30 2017-04-30 09:20:35 2017-04-30 10:54:46
## 31 2017-05-01 09:27:28 2017-05-01 11:51:22
## 32 2017-05-01 09:27:28 2017-05-01 19:37:26
## 33 2017-05-01 09:27:28 2017-05-01 19:55:11
## 34 2017-05-06 21:38:02 2017-05-06 21:40:14
## 35 2017-05-08 08:53:01 2017-05-09 08:06:06
########################################################################################################################—•°
...
#for(p in packages){ l[[2]] = as.name(p);  eval(l) }    #!!! YEAH!!!
 ...
 for(p in packages){library(p,character.only = TRUE)}  ## simpler but less sexy :)
...
ls(pattern='^(D|d)ata')   ## budujemy model na Data.ref;
   ...
   dim(data.ref)   ## 16204    61
   dim(Data.ref)   ## 16013    59
...
variables$Y <- variables$ref1$not_regressors[-(16:19)]
...
(  VAR$df <-
   ...
   ## NAZWY zmiennych celu Y wg. ich rodzaju/typu -- ALE to nie s¹ NAZWY metod budowy modeli !!!
        , data.frame( meaning = "pays"       ## oryginalne — NIEprzekszta³cone
                  , name = "suma_wplat_po_wizycie_do_30_dni"
                     , gam = "poisson"
      ...
      #               , gam = "poisson" )
        , data.frame( meaning = "efficiency"                 ## skutecznosc oryginalna
                  , name = "skutecznosc_po_wizycie_do_30_dni"
                     , gam = ""
                        , model = FALSE , rf = FALSE , plot = TRUE
                         )
        , data.frame( meaning = "efficiency_1"               ## skutecznosc obciêta do 1
                  , name = "skutecznosc_po_wizycie_do_30_dni_1"
                     , gam = "binomial"
