...
## for these attributes to take effect when printing object.
...
attributes(mm)
attributes(tmm)
## Notice that `tmm` has not class attr. thus is not a "tm" object — it's just ordinary atomic with dimensions.
